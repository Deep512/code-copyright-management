const TestGas = artifacts.require("TestGas");
...
contract("Test TestGas", async (accounts) => {
	it("should add and get new Code file", async () => {
		...
		// const res2 = await contract.checkIfPlagiarised(hashSet,hashSet.length);
		// console.log(res2);
		const fc = await contract.fileCount();
		console.log(fc);
